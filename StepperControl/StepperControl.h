...
class StepperControl    {
    ...
    void rotateClockwise(int del = 2000, int serialData = 360);
    void rotateAnticlockwise(int del = 2000,int serialData = 360);
    void rotate(char dir, int serialPort = 0);
    void rotateToAngle(int del, int X, int Y, int serialData = 0);
};
